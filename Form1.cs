...
namespace APIX_Winform_Demo
{
    public partial class Form1 : Form
    {
        ...
        static APIXSensor Sensor1;
        static APIXSensor Sensor2;
        ...
        private bool initSR_APIx()
        {
            ...
            Sensor2 = new APIXSensor();

            Sensor1 = new APIXSensor();
        ...
        /// <summary>
        /// Initial Sensor1 for ECCO 95.040+
        /// </summary>
        private async void initial_Sensor0()
        {
            Sensor1.MIPAddress = "192.168.179.200";
            ...
            if (result)
            {
                ...
                Sensor1.NumberOfProfileToCapture = 3500;
                ...
                List<ExposureGain> exposureGains = new List<ExposureGain>
                {
                   ...
                   // new ExposureGain(10d, 2),
                    new ExposureGain(10d, 3),new ExposureGain(30d, 3),
                };
        ...
        /// <summary>
        /// Initial Sensor2 for ECCO X025
        /// </summary>
        private async void initial_Sensor1()
        {
            var result = await Sensor2.Connect();
            if (result)
            {
                log.Info(Sensor2.SensorFWVersion);
                HiPerfTimer.Stop();
                log.Info("Connect sensor taken:" + HiPerfTimer.Duration + "ms");
                HiPerfTimer.Start();
                Sensor2.AcquisitionType = ImageAcquisitionType.ZMapIntensityLaserLineThickness;
                Sensor2.NumberOfProfileToCapture = 3500;
                Sensor2.PackSize = 100;
                ...
                Sensor2.CallBackTimeout = new System.Timers.Timer();

                //Sensor2.ConfigFilePath=tbx_ConfigFilePath.Text="";
        ...
        private void comboBox_ImageType_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox.SelectedIndex == 0)
            {
                ...
                Sensor2.AcquisitionType = ImageAcquisitionType.LiveImage;

            }
            else if (comboBox.SelectedIndex == 1)
            {
                Sensor1.AcquisitionType = ImageAcquisitionType.Profile;
                Sensor2.AcquisitionType = ImageAcquisitionType.Profile;

            }
            else if (comboBox.SelectedIndex == 2)
            {
                Sensor1.AcquisitionType = ImageAcquisitionType.ProfileIntensityLaserLineThickness;
                Sensor2.AcquisitionType = ImageAcquisitionType.ProfileIntensityLaserLineThickness;

            }
            else if (comboBox.SelectedIndex == 3)
            {
                Sensor1.AcquisitionType = ImageAcquisitionType.ZMap;
                Sensor2.AcquisitionType = ImageAcquisitionType.ZMap;
            ...
            else if (comboBox.SelectedIndex == 5)
            {
                ...
                Sensor2.AcquisitionType = ImageAcquisitionType.PointCloud;
